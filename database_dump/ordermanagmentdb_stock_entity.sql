...
CREATE TABLE `stock_entity` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK3mwp75xl064etpqdc1kqhtepy` (`product_id`),
  CONSTRAINT `FK3mwp75xl064etpqdc1kqhtepy` FOREIGN KEY (`product_id`) REFERENCES `product_entity` (`id`)
...
INSERT INTO `stock_entity` VALUES (1,2,'2023-06-24 00:00:00.000000',3),(2,2,'2023-06-24 00:00:00.000000',1);
...
-- Dump completed on 2023-06-30 15:41:08
